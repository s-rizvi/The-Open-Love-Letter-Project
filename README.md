...
* (Optional) For a full copy of the original manuscript source code, click the green `code` button at the top of the page to download the entire project as a zip file (unzip after download), open [`Manuscript.ipynb`](./Manuscript.ipynb) in [JupyterLab](https://jupyter.org/) and run all code cells (Shift + Enter) to view the inline PDFs, calculations, and graphs.
